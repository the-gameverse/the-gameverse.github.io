document.addEventListener('DOMContentLoaded', () => { // Ensure DOM is loaded before executing the script
    ...
    navbar.innerHTML = `
      <div class="navbar">
        <div class="navbar-left">
          <a href="/index.html"><img src="/uploads/branding/favicon.png" alt="Logo" width="10%" height="10%"></a>
          <a href="/index.html" class="gradient-red">GameVerse</a>
        </div>
  ...
  style.innerHTML = `
    ...
    .profile-img:hover {border: 2px solid white;}
